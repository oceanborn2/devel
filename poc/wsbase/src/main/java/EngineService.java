    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/GitHub/devel/poc/wsproxy/src/main/java/wsproxy/ews.wsdl");
    ...
    public EngineWebService getEngineServicePort() {
        return super.getPort(new QName("urn:hpexstream-services/Engine", "EngineServicePort"), EngineWebService.class);
    }
    ...
    public EngineWebService getEngineServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("urn:hpexstream-services/Engine", "EngineServicePort"), EngineWebService.class, features);
    }
